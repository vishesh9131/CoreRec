...
class NodeRecommender(Module):
    def __init__(self, input_dim, hidden_dim, output_dim):
        super(NodeRecommender, self).__init__()
        ...
        self.linear3 = Linear(hidden_dim + 1, output_dim)  # +1 for centrality score
        self.relu = ReLU()
...
if __name__ == "__main__":
    ...
    model = NodeRecommender(input_dim=dataset.num_node_features, hidden_dim=64, output_dim=1)
    output = model(data)
    print(output)