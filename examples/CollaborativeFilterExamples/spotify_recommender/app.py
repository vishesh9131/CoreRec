...
def search():
    ...
    if recommender is None:
        return render_template(
            "search.html", user_id=user_id, query=query, results=[], sample_artists=sample_artists
        )
    ...
    return render_template(
        "search.html", user_id=user_id, query=query, results=results, sample_artists=sample_artists
    )
...
def liked_songs():
    ...
    return render_template(
        "liked.html", user_id=user_id, liked_songs=liked_songs, sample_artists=sample_artists
    )
...
def like_song():
    ...
    if song_key in recommender.song_index_mapping:
        ...
        real_time_recommendations = recommender.get_real_time_recommendations(
            user_id, n_recommendations=5
        )

        return jsonify({"success": True, "recommendations": real_time_recommendations})
...
def unlike_song():
    ...
    if song_key in recommender.song_index_mapping:
        song_id = recommender.song_index_mapping[song_key]
        if (
            user_id in recommender.user_preferences
            and song_id in recommender.user_preferences[user_id]
        ):
            ...
            return jsonify({"success": True, "recommendations": updated_recommendations})
...
def real_time_recommendations():
    ...
    return jsonify({"success": True, "recommendations": real_time_recs})
...
def get_more_from_artist(artist_name, exclude_song=None, n_songs=4):
    ...
    if exclude_song:
        ...
        artist_songs = artist_songs[
            ~artist_songs.apply(
                lambda row: f"{row['artist']} - {row['song']}" == exclude_song, axis=1
            )
        ]
...
def get_dummy_recommendations(n_songs=8):
    dummy_songs = [
        ...
        },
        {
            ...
            "song": "Billie Jean",
            "song_key": "Michael Jackson - Billie Jean",
            "score": 0.85,
            "reason": "Popular song",
            "is_liked": False,
        },
        {
            ...
            "song_key": "Led Zeppelin - Stairway to Heaven",
            "score": 0.83,
            "reason": "Classic rock",
            "is_liked": False,
        },
        {
            ...
            "song_key": "Pink Floyd - Comfortably Numb",
            "score": 0.81,
            "reason": "Classic rock",
            "is_liked": False,
        },
        {
            ...
            "song": "Paint It Black",
            "song_key": "The Rolling Stones - Paint It Black",
            "score": 0.79,
            "reason": "Classic rock",
            "is_liked": False,
        },
        {
            ...
            "song_key": "Eagles - Hotel California",
            "score": 0.77,
            "reason": "Classic rock",
            "is_liked": False,
        },
        {
            ...
            "song_key": "Nirvana - Smells Like Teen Spirit",
            "score": 0.75,
            "reason": "90s rock",
            "is_liked": False,
        },
