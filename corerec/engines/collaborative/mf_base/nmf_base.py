...
For similar functionality, please use: sklearn.decomposition.NMF
...
class NMFBase:
    """
    Nmf - Placeholder for future implementation.
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            f"\n\nNMFBase is not yet implemented.\n\n"
            f"This feature is planned for CoreRec v0.6.0 or later.\n\n"
            f"For similar functionality, please use: sklearn.decomposition.NMF\n\n"
