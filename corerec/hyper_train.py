...
def train_model(
    ...
    try:
        for epoch in range(num_epochs):
            ...
            for batch_idx, (inputs, batch_adj, targets) in enumerate(
                    data_loader, 1):
                try:
            ...
            if batch_count > 0:
                ...
                print(
                    f"Epoch [{epoch + 1}/{num_epochs}], Average Loss: {avg_epoch_loss:.4f}")
                ...
                if avg_epoch_loss < best_loss:
                    ...
                    epochs_no_improve += 1
                    print(
                        f"No improvement in loss for {epochs_no_improve} epoch(s).")
                ...
                print(
                    f"Epoch [{epoch + 1}/{num_epochs}] skipped due to no successful batches.")
