...
import shutil
import pandas as pd
from corerec.engines.unionizedFilterEngine.nn_base.DCN_base import DCN_base, CrossLayer, DNN, DCNModel
...
class TestDCNBase(unittest.TestCase):
    ...
    def test_recommend(self):
        ...
        try:
            ...
            recommendations_with_ignore = self.model.recommend(user, top_n=5, items_to_ignore=items_to_ignore)
            ...
            recommendations_with_features = self.model.recommend(user, top_n=5, additional_features=features)
            ...
            def mock_recommend(user_id, top_n=10, additional_features=None, items_to_ignore=None):
                ...
                if items_to_ignore:
                    items_to_consider = [item for item in items_to_consider if item not in items_to_ignore]
