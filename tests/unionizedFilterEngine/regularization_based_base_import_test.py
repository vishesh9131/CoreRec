...
BASE = Path(__file__).resolve().parents[2] / "corerec" / "engines" / "unionizedFilterEngine" / "regularization_based_base"
...
class TestRegularizationBasedBaseImports(unittest.TestCase):
