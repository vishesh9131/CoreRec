...
```python
from corerec.sandbox.collaborative_full.nn_base.DCN_base import DCN_base
...
```python
# Save model
model.save('artifacts/dcn_base_model')

# Load model
loaded = DCN_base.load('artifacts/dcn_base_model')
