...
from corerec.cr_pkg.sage_conv import SAGEConv  # Import SAGEConv
...
class MovieSAGERecommender(nn.Module):
    def __init__(self, num_users, num_movies, hidden_dim, out_dim):
        super(MovieSAGERecommender, self).__init__()
...
model = MovieSAGERecommender(num_users, num_movies, hidden_dim=64, out_dim=32)
