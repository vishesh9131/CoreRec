...
adj_matrix = pd.read_csv('SANDBOX/Analysis/label.csv', header=None).values
...
class HAN(torch.nn.Module):
    def __init__(self, in_channels, out_channels, num_meta_paths, metadata):
        ...
        self.conv1 = HANConv(in_channels, 16, num_meta_paths, metadata)
        self.conv2 = HANConv(16, out_channels, num_meta_paths, metadata)
