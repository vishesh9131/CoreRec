...
import tempfile
import shutil
from corerec.engines.unionizedFilterEngine.nn_base.NFM_base import (
    NFM_base,
...
class TestNFMModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.model = NFMModel(self.field_dims, self.embed_dim, self.hidden_dims)
...
class TestNFMBase(unittest.TestCase):
    ...
    def test_config_override(self):
        ...
        model_with_config = NFM_base(name="ConfigNFM", config=config, verbose=False)
    ...
    def test_fit(self):
        ...
        try:
            ...
            self.model.field_dims = [
                len(self.model.user_map),
                len(self.model.item_map),
                3,
                1,
                5,
                2,
    ...
    def test_recommend(self):
        ...
        try:
            ...
            recommendations_with_features = self.model.recommend(
                user, top_n=top_n, features=features
            )
    ...
    def test_feature_importance(self):
        ...
        try:
            ...
            self.model.export_feature_importance = mock_export_feature_importance.__get__(
                self.model
            )
