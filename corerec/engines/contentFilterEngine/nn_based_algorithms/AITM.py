...
from corerec.engines.contentFilterEngine.learning_paradigms.transfer_learning import (
    TransferLearningLearner,
)
import logging
...
class AITM:
    def __init__(self, input_dim, feature_dim, output_dim, verbose=False):
    ...
    def transfer_knowledge(self, data_loader, criterion, optimizer, num_epochs):
        transfer_learner = TransferLearningLearner(
            self.target_model, data_loader, criterion, optimizer, num_epochs
        )
