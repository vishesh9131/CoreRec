# NextItNet Tutorial: Next Item Net
...
**NextItNet** is a Neural Network Models model for recommendation systems. This model implements Next Item Net.

## How NextItNet Works

### Architecture

NextItNet uses a sophisticated architecture for recommendation tasks.
...
```python
from corerec.sandbox.collaborative_full.sequential_model_base.nextitnet_base import NextItNet_base as NextItNet
