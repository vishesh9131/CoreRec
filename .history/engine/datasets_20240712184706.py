...
class GraphDataset(Dataset):
    def __init__(self, adj_matrix, weight_matrix=None, labels=None):
    ...
    def __getitem__(self, idx):
        ...
        if self.labels is not None:
            return node_features, self.labels[idx]  # Return labels as targets if provided
        return node_features, node_features  # Return node_features as targets if no weights or labels
