...
CUDA_IDENTIFIER_MAP = collections.OrderedDict(
    [
        ...
        (
            ...
            ("hipGraphDebugDotFlagsVerbose", CONV_NUMERIC_LITERAL, API_RUNTIME),
        ),
        ...
        (
            ...
            ("hipUserObjectNoDestructorSync", CONV_TYPE, API_RUNTIME),
        ),
        (
        ...
        ("cublasComputeType_t", ("hipblasComputeType_t", CONV_MATH_FUNC, API_BLAS)),
        ("CUBLAS_COMPUTE_32I", ("HIPBLAS_COMPUTE_32I", CONV_MATH_FUNC, API_BLAS)),
        ("CUBLAS_COMPUTE_32F", ("HIPBLAS_COMPUTE_32F", CONV_MATH_FUNC, API_BLAS)),
        ("CUBLAS_COMPUTE_64F", ("HIPBLAS_COMPUTE_64F", CONV_MATH_FUNC, API_BLAS)),
        ...
        (
            ...
            ("hipblasLtMatrixLayoutSetAttribute", CONV_MATH_FUNC, API_BLAS),
        ),
        (
            "CUBLASLT_MATRIX_LAYOUT_BATCH_COUNT",
            ("HIPBLASLT_MATRIX_LAYOUT_BATCH_COUNT", CONV_MATH_FUNC, API_BLAS),
        ),
        (
            "CUBLASLT_MATRIX_LAYOUT_STRIDED_BATCH_OFFSET",
            ("HIPBLASLT_MATRIX_LAYOUT_STRIDED_BATCH_OFFSET", CONV_MATH_FUNC, API_BLAS),
        ),
