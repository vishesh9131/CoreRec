# VMF Tutorial: Von Mises-Fisher Distribution
...
**VMF** is a Bayesian Models model for recommendation systems. This model implements Von Mises-Fisher Distribution.

## How VMF Works

### Architecture

VMF uses a sophisticated architecture for recommendation tasks.
...
```python
from corerec.sandbox.collaborative_full.mf_base.vmf_base import VMF_base as VMF
...
```python
# Save model
model.save('artifacts/vmf_model')

# Load model
loaded = VMFBase.load('artifacts/vmf_model')
...
✅ Best for datasets with bayesian models characteristics
