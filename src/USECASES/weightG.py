...
file_path1 = vg.generate_weight_matrix(
    num_nodes, weight_range=(1, 10), file_path="weight_matrix.csv", seed=42
)
...
# 3dVisulizn
vg.draw_graph_3d(
    adj_matrix, node_labels=node_labels, top_nodes=top_nodes, edge_weights=weight_matrix
)
