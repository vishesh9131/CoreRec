"""
Multirelationaluf - NOT YET IMPLEMENTED
...
class MultiRelationalUFBase:
    """
    Multirelationaluf - Placeholder for future implementation.
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            f"\n\nMultiRelationalUFBase is not yet implemented.\n\n"
