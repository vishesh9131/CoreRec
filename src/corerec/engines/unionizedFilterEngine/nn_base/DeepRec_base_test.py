...
import tempfile
import shutil
from corerec.engines.unionizedFilterEngine.nn_base.DeepRec_base import (
    DeepRec_base,
    AttentionLayer,
    SequenceEncoder,
    DeepRecModel,
...
class TestSequenceEncoder(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sequence_encoder = SequenceEncoder(
            self.embed_dim, self.hidden_dim, self.num_layers, self.attention_dim, self.dropout
        )
...
class TestDeepRecBase(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertFalse(
            hasattr(self.model, "is_fitted") or getattr(self.model, "is_fitted", False)
        )
