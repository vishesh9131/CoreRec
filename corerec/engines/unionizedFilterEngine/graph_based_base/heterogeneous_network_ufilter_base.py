"""
Heterogeneousnetworkuf - NOT YET IMPLEMENTED
...
class HeterogeneousNetworkUFBase:
    """
    Heterogeneousnetworkuf - Placeholder for future implementation.
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            f"\n\nHeterogeneousNetworkUFBase is not yet implemented.\n\n"
