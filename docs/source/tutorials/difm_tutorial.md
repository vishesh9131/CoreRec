# DIFM Tutorial: Dual Input Factorization Machine
...
**DIFM** is a Neural Network Models model for recommendation systems. This model implements Dual Input Factorization Machine.

## How DIFM Works

### Architecture

DIFM uses a sophisticated architecture for recommendation tasks.
...
```python
from corerec.sandbox.collaborative_full.nn_base.DIFM_base import DIFM_base as DIFM
...
```python
# Save model
model.save('artifacts/difm_model')

# Load model
loaded = DIFM_base.load('artifacts/difm_model')
