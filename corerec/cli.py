...
def list_models(args):
    ...
    models = {
        'deep': ['DCN', 'DeepFM', 'GNNRec', 'MIND', 'NASRec', 'SASRec', 'DIEN'],
        'collaborative': ['FastRecommender', 'GeoMLC', 'RBM', 'RLRMC', 'SAR'],
        'content': ['TFIDFRecommender', 'Word2Vec', 'Doc2Vec', 'BERT'],
...
""")
    ...
    dependencies = [
        'torch', 'pandas', 'numpy', 'sklearn', 'scipy'
    ]
...
def main():
    ...
    # Version command
    version_parser = subparsers.add_parser('version', help='Show CoreRec version')
    version_parser.set_defaults(func=show_version)
    
    # Engines command
    engines_parser = subparsers.add_parser('engines', help='List all available engines')
    engines_parser.set_defaults(func=list_engines)
    
    # Models command
    models_parser = subparsers.add_parser('models', help='List available models')
    models_parser.add_argument('category', nargs='?', default='all',
