...
def get_pip_packages(run_lambda, patterns=None):
    ...
    def run_with_pip(pip):
        ...
        return "\n".join(
            line for line in out.splitlines() if any(
                name in line for name in patterns))
