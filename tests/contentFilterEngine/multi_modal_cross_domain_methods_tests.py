...
BASE = Path(__file__).resolve().parents[2] / "corerec" / "engines" / "contentFilterEngine" / "multi_modal_cross_domain_methods"
...
class TestMultiModalCrossDomain(unittest.TestCase):
    ...
    def test_cross_domain_transfer_eval(self):
        ...
        cd.transfer_knowledge(data, criterion=criterion, optimizer=optimizer, num_epochs=1)
