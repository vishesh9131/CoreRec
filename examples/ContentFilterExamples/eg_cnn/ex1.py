...
# Import CNN using the top-level module pattern
...
def main():
    ...
    avg_hr, avg_ndcg = evaluate_all(cnn_model, dataset, dataset.idx_to_genre, k=k, device=device)
