...
BASE = Path(__file__).resolve().parents[2] / "corerec" / "engines" / "unionizedFilterEngine" / "attention_mechanism_base"
...
class TestAttentionMechanismBaseImports(unittest.TestCase):
