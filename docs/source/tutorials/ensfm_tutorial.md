# ENSFM Tutorial: Ensemble Factorization Machine
...
**ENSFM** is a Neural Network Models model for recommendation systems. This model implements Ensemble Factorization Machine.

## How ENSFM Works

### Architecture

ENSFM uses a sophisticated architecture for recommendation tasks.
...
```python
from corerec.sandbox.collaborative_full.nn_base.ENSFM_base import ENSFM_base as ENSFM
...
```python
# Save model
model.save('artifacts/ensfm_model')

# Load model
loaded = ENSFM_base.load('artifacts/ensfm_model')
