...
class TorchRecommender(BaseRecommender):
    ...
    def fit(self, data: Union[pd.DataFrame, Dict, Any], **kwargs) -> "TorchRecommender":
        ...
        """
        raise NotImplementedError("Subclasses must implement fit() with specific training logic")
    ...
    def predict(self, user_id: Any, item_id: Any, **kwargs) -> float:
        ...
        Returns:
            Predicted score
        """
        raise NotImplementedError("Subclasses must implement predict() for scoring user-item pairs")
