# FM Tutorial: Factorization Machine
...
**FM** is a Neural Network Models model for recommendation systems. This model implements Factorization Machine.

## How FM Works

### Architecture

FM uses a sophisticated architecture for recommendation tasks.
...
```python
from corerec.sandbox.collaborative_full.nn_base.FM_base import FM_base as FM
...
```python
# Save model
model.save('artifacts/fm_model')

# Load model
loaded = FM_base.load('artifacts/fm_model')
