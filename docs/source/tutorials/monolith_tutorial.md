...
```python
from corerec.sandbox.collaborative_full.nn_base.Monolith_base import Monolith_base as Monolith
...
```python
# Save model
model.save('artifacts/monolith_model')

# Load model
loaded = Monolith.load('artifacts/monolith_model')
