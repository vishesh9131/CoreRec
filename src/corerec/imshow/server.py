    ...
    class APIHandler(http.server.BaseHTTPRequestHandler):
        def do_GET(self):
            try:
                ...
                if path == "/":
                    response = {"message": "CoreRec IMShow API", "connector": connector.get_info()}
