...
# num_people=100
# file_path = vg.generate_random_graph(num_people, file_path="/dataset/blobbag.csv",seed=56)
#     # adj_matrix= np.loadtxt(file_path,delimiter=",")
# file_path2 = vg.generate_weight_matrix(12,weight_range=(0,1),file_path="/dataset/weight_matrix.csv",seed=89)
