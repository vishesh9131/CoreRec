...
def validate_user_id(user_id: Any, user_map: Dict[Any, int], allow_unknown: bool = False) -> None:
    """
...
def validate_item_id(item_id: Any, item_map: Dict[Any, int], allow_unknown: bool = False) -> None:
    """
...
def validate_embeddings_dim(embedding_dim: int, min_val: int = 1, max_val: int = 1024) -> None:
    """
