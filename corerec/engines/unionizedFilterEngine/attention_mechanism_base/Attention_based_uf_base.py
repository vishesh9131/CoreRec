...
class AttentionBasedUFBase:
    """
    Attentionduf - Placeholder for future implementation.
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            f"\n\nAttentionBasedUFBase is not yet implemented.\n\n"
            f"This feature is planned for CoreRec v0.6.0 or later.\n\n"
            f"For similar functionality, please use: DIN or DIEN\n\n"
