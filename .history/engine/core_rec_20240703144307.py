...
class GraphTransformer(nn.Module):
    '''
    This is a transformer model for graph data. It is a combination of a linear layer and a transformer encoder.
    The linear layer is used to transform the input data to the dimension of the transformer.
    The transformer encoder is used to process the input data.
    '''
