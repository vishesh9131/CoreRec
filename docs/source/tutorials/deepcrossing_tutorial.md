# DeepCrossing Tutorial: Deep Crossing Network
...
**DeepCrossing** is a Neural Network Models model for recommendation systems. This model implements Deep Crossing Network.

## How DeepCrossing Works

### Architecture

DeepCrossing uses a sophisticated architecture for recommendation tasks.
...
```python
from corerec.sandbox.collaborative_full.nn_base.DeepCrossing_base import DeepCrossing_base as DeepCrossing
...
```python
model = DeepCrossing_base(
    name="DeepCrossing_Model",
    embedding_dim=64,
    epochs=20,
    batch_size=256,
    learning_rate=0.001,
