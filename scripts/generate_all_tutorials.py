#!/usr/bin/env python3
"""
Generate Sphinx tutorials for ALL 29 models with CORRECT cr_learn API

Models: 
Batch 1 (10): DCN, DeepFM, GNNRec, MIND, NASRec, SASRec, NCF, LightGCN, DIEN, DIN
Batch 2 (11): BPR, SVD, RBM, AutoInt, ALS, Bert4Rec, DLRM, FFM, Caser, BiVAE, AFM
Batch 3 (4): A2SVD, BST, BPRMF, GeoIMC
Batch 4 (4): WideDeep, YouTubeDNN, NFM, PNN
"""
