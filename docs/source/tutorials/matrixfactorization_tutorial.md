# MatrixFactorization Tutorial: Matrix Factorization
...
**MatrixFactorization** is a Matrix Factorization Models model for recommendation systems. This model implements Matrix Factorization.

## How MatrixFactorization Works

### Architecture

MatrixFactorization uses a sophisticated architecture for recommendation tasks.
...
```python
from corerec.sandbox.collaborative_full.mf_base.matrix_factorization_base import MatrixFactorization_base as MatrixFactorization
...
model = MatrixFactorization(
    name="MatrixFactorization_Model",
    embedding_dim=64,
    epochs=20,
    batch_size=256,
    learning_rate=0.001,
...
### When to Use MatrixFactorization

✅ Best for datasets with matrix factorization models characteristics
