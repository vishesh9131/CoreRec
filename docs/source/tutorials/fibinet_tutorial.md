# Fibinet Tutorial: Feature Importance and Bilinear feature Interaction
...
**Fibinet** is a Neural Network Models model for recommendation systems. This model implements Feature Importance and Bilinear feature Interaction.

## How Fibinet Works

### Architecture

Fibinet uses a sophisticated architecture for recommendation tasks.
...
```python
from corerec.sandbox.collaborative_full.nn_base.Fibinet_base import Fibinet_base as Fibinet
...
```python
# Save model
model.save('artifacts/fibinet_model')

# Load model
loaded = Fibinet_base.load('artifacts/fibinet_model')
