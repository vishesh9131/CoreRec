...
class TDM(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim=128, dropout=0.5, num_classes=1):
        """
        ...
        self.conv = nn.Conv1d(
            in_channels=embedding_dim, out_channels=hidden_dim, kernel_size=3, padding=1
        )
