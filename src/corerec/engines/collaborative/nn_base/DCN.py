...
from corerec.engines.collaborative.nn_base.DCN_base import DCN_base
...
class DCN(DCN_base):
    ...
    def __init__(
        ...
        super().__init__(name=name, config=config, seed=seed)
...
if __name__ == "__main__":
    ...
    # Create model
    model = DCN(
        name="ExampleDCN", embedding_dim=8, num_cross_layers=2, deep_layers=[16, 8], num_epochs=5
    )
