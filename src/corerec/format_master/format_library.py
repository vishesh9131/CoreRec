...
try:
    ...
    logging.info(
        format_info("xml.etree.ElementTree is not available. XML files will not be supported.")
    )
...
try:
    ...
    logging.info(
        format_info("Feather format is not available. Feather files will not be supported.")
    )
...
try:
    ...
    logging.info(
        format_info("pandas.io.parsers is not available. Fixed-width files will not be supported.")
    )
...
try:
    ...
    logging.info(
        format_info("Pystan is not available. Protocol Buffers files will not be supported.")
    )
...
try:
    ...
    logging.info(
        format_info(
            "SQLAlchemy is not available. SQL Server and PostgreSQL exports will not be supported."
        )
    )
...
try:
    ...
    logging.info(
        format_info("gspread or google-auth is not available. Google Sheets will not be supported.")
    )
...
def check_pymongo_support():
    try:
        ...
        logging.info(
            format_info("PyMongo is not available. MongoDB exports will not be supported.")
        )
...
def check_gspread_support():
    try:
        ...
        logging.info(
            format_info(
                "gspread or google-auth is not available. Google Sheets will not be supported."
            )
        )
