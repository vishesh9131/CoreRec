...
def app():
    ...
    adj_matrix = np.loadtxt('./CoreRec/SANDBOX/adj.csv', delimiter=",")

    wgt_matrix = np.loadtxt('./CoreRec/SANDBOX/label.csv', delimiter=",")

    df = pd.read_csv("./CoreRec/SANDBOX/labelele.csv")
