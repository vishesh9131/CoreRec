# DeepFM_base Tutorial: DeepFM Base
...
**DeepFM_base** is a Neural Network Models model for recommendation systems. This model implements DeepFM Base.

## How DeepFM_base Works

### Architecture

DeepFM_base uses a sophisticated architecture for recommendation tasks.
...
```python
from corerec.sandbox.collaborative_full.nn_base.DeepFM_base import DeepFM_base
...
```python
# Save model
model.save('artifacts/deepfm_base_model')

# Load model
loaded = DeepFM_base.load('artifacts/deepfm_base_model')
