...
class GAN_ufilter_base(BaseRecommender):
    """
    ...
    def _build_models(self):
        ...
        # Build generator
        generator_dims = (
            [self.noise_dim + self.feature_dim] + self.gen_hidden_dims + [self.feature_dim]
        )
    ...
    def save(self, filepath: str):
        ...
        model_data = {
            ...
            "history": {"disc_losses": self.disc_losses, "gen_losses": self.gen_losses},
        }
    ...
    def fit(self, data: Dict[str, Any]) -> "GAN_ufilter_base":
        ...
        for epoch in range(self.num_epochs):
            epoch_metrics = {"d_loss": 0.0, "g_loss": 0.0, "d_real": 0.0, "d_fake": 0.0}
