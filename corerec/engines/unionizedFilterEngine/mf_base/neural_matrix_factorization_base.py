"""
Neuralmatrixfactorization - NOT YET IMPLEMENTED

WARNING: This feature is currently under development and not ready for production use.

For similar functionality, please use: NCF (Neural Collaborative Filtering)
...
class NeuralMatrixFactorizationBase:
    """
    Neuralmatrixfactorization - Placeholder for future implementation.
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            f"\n\nNeuralMatrixFactorizationBase is not yet implemented.\n\n"
            f"This feature is planned for CoreRec v0.6.0 or later.\n\n"
            f"For similar functionality, please use: NCF (Neural Collaborative Filtering)\n\n"
