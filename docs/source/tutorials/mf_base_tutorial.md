...
```python
from corerec.engines.matrix_factorization.mf_base import MatrixFactorizationBase
import cr_learn
import numpy as np
...
```python
# Save model
model.save('mf_base_model.pkl')

# Load model
loaded = MatrixFactorizationBase.load('mf_base_model.pkl')
