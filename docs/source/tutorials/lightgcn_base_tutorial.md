# LightGCN_Base Tutorial: LightGCN Base
...
**LightGCN_Base** is a Graph-Based Models model for recommendation systems. This model implements LightGCN Base.

## How LightGCN_Base Works

### Architecture

LightGCN_Base uses a sophisticated architecture for recommendation tasks.
...
```python
from corerec.sandbox.collaborative_full.graph_based_base.lightgcn_base import LightGCN_base
...
```python
# Save model
model.save('artifacts/lightgcn_base_model')

# Load model
loaded = LightGCNBase.load('artifacts/lightgcn_base_model')
...
### When to Use LightGCN_Base

✅ Best for datasets with graph-based models characteristics
