...
BASE = Path(__file__).resolve().parents[2] / "corerec" / "engines" / "unionizedFilterEngine" / "variational_encoder_base"
...
class TestVariationalEncoderBaseImports(unittest.TestCase):
