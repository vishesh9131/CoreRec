...
CUDA_TYPE_NAME_MAP = collections.OrderedDict(
    [
        ...
        ("curandDistributionShift_t",
         ("hiprandDistributionShift_t",
          CONV_TYPE,
          API_RAND,
          HIP_UNSUPPORTED),
         ),
        ("curandDistributionM2Shift_st",
         ("hiprandDistributionM2Shift_st",
          CONV_TYPE,
          API_RAND,
          HIP_UNSUPPORTED),
         ),
        ("curandDistributionM2Shift_t",
         ("hiprandDistributionM2Shift_t",
          CONV_TYPE,
          API_RAND,
          HIP_UNSUPPORTED),
         ),
        ("curandHistogramM2_st",
         ("hiprandHistogramM2_st",
          CONV_TYPE,
          API_RAND,
          HIP_UNSUPPORTED),
         ),
        ("curandHistogramM2_t",
         ("hiprandHistogramM2_t",
          CONV_TYPE,
          API_RAND,
          HIP_UNSUPPORTED),
         ),
...
CUDA_INCLUDE_MAP = collections.OrderedDict(
    [
        ...
        # PyTorch also has a source file named "nccl.h", so we need to "<"">"
        # to differentiate
    ...
    [
        ...
        (
            ...
            ("hipErrorMissingConfiguration",
             CONV_TYPE, API_RUNTIME, HIP_UNSUPPORTED),
        ),
        (
        ...
        (
            ...
            ("hipErrorDuplicateVariableName",
             CONV_TYPE, API_RUNTIME, HIP_UNSUPPORTED),
        ),
        (
            "cudaErrorDuplicateTextureName",
            ("hipErrorDuplicateTextureName",
             CONV_TYPE, API_RUNTIME, HIP_UNSUPPORTED),
        ),
        (
            "cudaErrorDuplicateSurfaceName",
            ("hipErrorDuplicateSurfaceName",
             CONV_TYPE, API_RUNTIME, HIP_UNSUPPORTED),
        ),
        (
        ...
        (
            ...
            ("hipComputeModeExclusiveProcess",
             CONV_TYPE, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
        ...
        (
            ...
            ("HIP_MEMHOSTALLOC_WRITECOMBINED",
             CONV_TYPE, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
            "CU_MEMHOSTREGISTER_DEVICEMAP",
            ("HIP_MEMHOSTREGISTER_DEVICEMAP",
             CONV_TYPE, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
        ...
        (
            ...
            ("hipResourceTypeMipmappedArray",
             CONV_TEX, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
        ...
        (
            ...
            ("hipStreamBatchMemOpWaitValue32",
             CONV_TYPE, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
            "CU_STREAM_MEM_OP_WRITE_VALUE_32",
            ("hipStreamBatchMemOpWriteValue32",
             CONV_TYPE, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
        ...
        (
            ...
            ("hipCtxGetStreamPriorityRange",
             CONV_CONTEXT, API_DRIVER, HIP_UNSUPPORTED),
        ),
        ...
        (
            ...
            ("HIP_GL_DEVICE_LIST_CURRENT_FRAME",
             CONV_GL, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
        ...
        (
            ...
            ("HIP_D3D9_DEVICE_LIST_NEXT_FRAME",
             CONV_D3D9, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
            "cuD3D9CtxCreate",
        ...
        (
            ...
            ("HIP_D3D10_REGISTER_FLAGS_NONE",
             CONV_D3D10, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
        ...
        (
            ...
            ("hipEGLStreamConsumerDisconnect",
             CONV_EGL, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
        ...
        (
            ...
            ("hipEGLStreamProducerDisconnect",
             CONV_EGL, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
        ...
        (
            ...
            ("hipEGLStreamProducerReturnFrame",
             CONV_EGL, API_DRIVER, HIP_UNSUPPORTED),
        ),
        (
    ...
    [
        ...
        (
            ...
            ("HIPSPARSE_SOLVE_POLICY_USE_LEVEL",
             CONV_NUMERIC_LITERAL, API_SPECIAL),
        ),
...
CAFFE2_SPECIFIC_MAPPINGS = collections.OrderedDict(
    [
        ...
        # the ordered dict guarantees this pattern will match first, before
        # "CUDA"
...
C10_MAPPINGS = collections.OrderedDict(
    [
        ...
        ("c10/cuda/CUDADeviceAssertion.h",
         ("c10/hip/HIPDeviceAssertion.h", API_C10)),
        ...
        ("c10/cuda/CUDAAllocatorConfig.h",
         ("c10/hip/HIPAllocatorConfig.h", API_C10)),
        ("c10/cuda/CUDACachingAllocator.h",
