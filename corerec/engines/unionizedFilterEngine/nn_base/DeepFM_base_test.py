...
class TestDeepFM(unittest.TestCase):
    ...
    def test_embeddings(self):
        ...
        try:
            ...
            if hasattr(self.model, 'get_user_embeddings') and original_get_user_embeddings is not self.model.get_user_embeddings:
                self.model.get_user_embeddings = original_get_user_embeddings
            if hasattr(self.model, 'get_item_embeddings') and original_get_item_embeddings is not self.model.get_item_embeddings:
    ...
    def test_update_incremental(self):
        ...
        try:
            ...
            if hasattr(self.model, 'update_incremental') and original_update_incremental is not self.model.update_incremental:
