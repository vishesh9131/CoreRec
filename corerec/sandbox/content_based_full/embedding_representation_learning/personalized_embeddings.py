# # corerec/engines/content_based/embedding_representation_learning/personalized_embeddings.py
"""
Maintainence UPDATE try1
"""
from typing import List, Dict, Any
from corerec.engines.content_based.embedding_representation_learning.word2vec import WORD2VEC
from corerec.engines.content_based.embedding_representation_learning.doc2vec import (
    SimpleDoc2Vec,
)
...
class PERSONALIZED_EMBEDDINGS:
    ...
    def __init__(
        ...
        self.doc2vec = SimpleDoc2Vec(**(doc2vec_params if doc2vec_params else {}))
