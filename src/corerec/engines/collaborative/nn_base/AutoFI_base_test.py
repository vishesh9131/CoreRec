...
from corerec.engines.collaborative.nn_base.AutoFI_base import AutoFI_base
...
def patched_load(cls, path: str):
    ...
    model = cls(name="TestAutoFI", config=model_state["config"])  # Use the fixed name for testing
...
class TestAutoFIBase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from corerec.engines.collaborative.nn_base.AutoFI_base import (
            FeaturesEmbedding,
            FeaturesLinear,
        )
        ...
        self.model = AutoFI_base(
            name="TestAutoFI", trainable=True, verbose=True, config=self.config, seed=42
        )
    ...
    def test_reproducibility(self):
        ...
        model1 = AutoFI_base(name="TestAutoFI1", config=model1_config, seed=42)
        ...
        model2 = AutoFI_base(name="TestAutoFI2", config=model2_config, seed=42)
