# GAN Tutorial: Generative Adversarial Network
...
**GAN** is a Neural Network Models model for recommendation systems. This model implements Generative Adversarial Network.

## How GAN Works

### Architecture

GAN uses a sophisticated architecture for recommendation tasks.
...
```python
from corerec.sandbox.collaborative_full.nn_base.gan_ufilter_base import GAN_ufilter_base as GAN
...
```python
# Save model
model.save('artifacts/gan_model')

# Load model
loaded = GAN_ufilter_base.load('artifacts/gan_model')
